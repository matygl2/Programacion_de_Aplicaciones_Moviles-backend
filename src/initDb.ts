    ...
    db.run(
      ...
      async (personError) => {
        ...
        try {
          ...
          await addColumnIfNeeded(db, "edad", "INTEGER NOT NULL DEFAULT 41");
            ...
            (updateError) => {
              ...
              db.get(
                ...
                (_countError, row: { count: number }) => {
                  ...
                  db.run(
                    `INSERT INTO "Person" ("firstName", "lastName", "edad", "arrivalDate", "isWorking") VALUES
                      ('Urist', 'McDwarf' , 84, '2026-09-15', 1),
                      ('Mafol', 'Craftsdwarf', 24, '2026-09-14', 1),
                      ('Domas', 'Stoneworker', 47, '2026-09-13', 0)`,
                    (seedError) => {
                      db.close();
